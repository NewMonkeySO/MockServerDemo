/** POST /passengers */
export const POST_PASSENGER_RESPONSE = {
    "id": "ps012345678",
    "first_name": "太郎",
    "last_name": "山田",
    "first_name_kana": "タロウ",
...
/** GET /passengers/{id} */
export const GET_PASSENGER_BY_ID_RESPONSE = {
    "id": "ps012345678",
    "first_name": "太郎",
    "last_name": "山田",
    "first_name_kana": "タロウ",
...
/** PUT /passengers/{id} */
export const PUT_PASSENGER_BY_ID_RESPONSE = {
    "id": "ps012345678",
    "first_name": "太郎",
    "last_name": "山田",
    "first_name_kana": "タロウ",
...
export const GET_PASSENGER_BY_ID_SERVICES_RESPONSE = {
    "services": [
        {
            "id": "sv012345678",
...
export const POST_PASSENGER_BY_ID_AGREEMENTS_RESPONSE = {
    "agreements": [
        {
...
export const GET_PASSENGER_AGREEMENTS_RESPONSE = {
    "agreements": [
        {
            "terms_id": "pt012345678",
            "term_category": "platform",
...
export const GET_PASSENGER_BY_ID_RESERVATIONS_RESPONSE = {
    "reservations": [
        {
            "id": "rs012345678",
