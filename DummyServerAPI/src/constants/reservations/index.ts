import type { GetReservationsIdPaymentResponse, PostReservationsCandidatesResponse, PostReservationsResponse, PutReservationsIdPaymentResponse, PutReservationsIdResponse } from "../../schemas/reservations/index.js";

/** POST /reservations/candidates */
export const POST_RESERVATIONS_CANDIDATES_RESPONSE:PostReservationsCandidatesResponse = {
  "candidates": [
    {
      "reservation_request": {
...
/** POST /reservations */
export const POST_RESERVATIONS_RESPONSE:PostReservationsResponse = {
  "id": "rs012345678",
...
/** PUT /reservations/:id */
export const PUT_RESERVATIONS_ID_RESPONSE:PutReservationsIdResponse = {
  "id": "rs012345678",
  "passenger_id": "ps012345678",
  "status": "confirmed",
  "service_id": "sv012345678",
...
export const GET_RESERVATIONS_ID_PAYMENT_RESPONSE:GetReservationsIdPaymentResponse = {
  "id": "rp012345678",
  "amount": 820,
...
export const PUT_RESERVATIONS_ID_PAYMENT_RESPONSE:PutReservationsIdPaymentResponse = {
  "id": "rp012345678",
  "amount": 820,
