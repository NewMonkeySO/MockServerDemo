...
import { getServicesQueryParametersSchema } from '../../schemas/services/index.js';
...
services.get('/services', zValidator('query', getServicesQueryParametersSchema, (result, c) => {
    if (!result.success) {
